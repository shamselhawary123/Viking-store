        ...
        <div class="mx-auto mt-12 max-w-4xl">
          <label class="relative block">
            ...
            <Icon
              ...
              class="absolute left-5 top-1/2 -translate-y-1/2 text-2xl text-neutral-500"
            />
            <input
              v-model="search"
              type="search"
      ...
      <div class="grid gap-8 lg:grid-cols-[0.72fr_1.28fr]">
        ...
        <div>
          ...
          <div v-if="filteredFaqs.length" class="space-y-4">
            ...
            >
              <button
                class="flex min-h-20 w-full items-center justify-between gap-5 p-5 text-left md:p-6"
                @click="toggleQuestion(faq.questionKey)"
              >
                <div>
                  <span
              ...
              <Transition name="accordion">
                <div
                  v-show="openQuestion === faq.questionKey"
                  class="px-5 pb-6 leading-8 text-neutral-400 md:px-6"
                >
                  {{ t(faq.answerKey) }}
                </div>
              </Transition>
        ...
        <div class="mx-auto max-w-3xl">
          ...
          <div class="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
            <NuxtLink
              ...
              >{{ t("pages.contactSupport") }}</NuxtLink
            >
            <a
      ...
      <div class="premium-panel rounded-2xl p-7 md:p-10">
        <div class="grid gap-8 lg:grid-cols-[1fr_0.9fr] lg:items-center">
          <div>
            ...
            <h2 class="display-heading mt-4 text-5xl text-white md:text-7xl">
              {{ t("pages.supportUpdates") }}
            </h2>
          ...
          <form class="grid gap-3 sm:grid-cols-[1fr_auto]" @submit.prevent>
            <label class="sr-only" for="faq-newsletter">{{
            ...
            <input
              ...
              autocomplete="email"
            />
            <button class="premium-button premium-button-primary" type="submit">
              {{ t("pages.joinNewsletter") }}
            </button>
          </form>
        </div>
      </div>
...
const faqs = [
  {
    categoryKey: "pages.ordersTopic",
    questionKey: "pages.faqTrackQ",
    answerKey: "pages.faqTrackA",
  },
  {
    categoryKey: "pages.ordersTopic",
    questionKey: "pages.faqChangeQ",
    answerKey: "pages.faqChangeA",
  },
  {
    categoryKey: "pages.shippingTopic",
    questionKey: "pages.faqShippingQ",
    answerKey: "pages.faqShippingA",
  },
  {
    categoryKey: "pages.paymentsTopic",
    questionKey: "pages.faqPaymentQ",
    answerKey: "pages.faqPaymentA",
  },
  {
    categoryKey: "pages.paymentsTopic",
    questionKey: "pages.faqSecureQ",
    answerKey: "pages.faqSecureA",
  },
  {
    categoryKey: "pages.returnsTopic",
    questionKey: "pages.faqReturnQ",
    answerKey: "pages.faqReturnA",
  },
  {
    categoryKey: "pages.returnsTopic",
    questionKey: "pages.faqDamagedQ",
    answerKey: "pages.faqDamagedA",
  },
  {
    categoryKey: "pages.productsTopic",
    questionKey: "pages.faqSizeQ",
    answerKey: "pages.faqSizeA",
  },
  {
    categoryKey: "pages.productsTopic",
    questionKey: "pages.faqBeginnerQ",
    answerKey: "pages.faqBeginnerA",
  },
  {
    categoryKey: "pages.accountTopic",
    questionKey: "pages.faqAccountQ",
    answerKey: "pages.faqAccountA",
  },
  {
    categoryKey: "pages.accountTopic",
    questionKey: "pages.faqPastOrdersQ",
    answerKey: "pages.faqPastOrdersA",
  },
];

const categories = computed(() => [
  "pages.all",
  ...new Set(faqs.map((faq) => faq.categoryKey)),
]);
const filteredFaqs = computed(() => {
  ...
  return faqs.filter((faq) => {
    const matchesCategory =
      ...
      faq.categoryKey === activeCategory.value;
    const matchesSearch =
      !query ||
      `${t(faq.questionKey)} ${t(faq.answerKey)} ${t(faq.categoryKey)}`
        .toLowerCase()
        .includes(query);
