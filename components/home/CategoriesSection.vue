  ...
  <section class="section-premium bg-black">
    <div class="container-premium">
      <div class="mx-auto mb-16 max-w-3xl text-center">
        ...
        <h2 class="display-heading mt-4 text-6xl text-white md:text-7xl">CHOOSE YOUR WEAPON</h2>
        <p class="mt-5 leading-8 text-neutral-400">
          Shop by discipline with gear built for bag work, sparring, conditioning, and fight week.
        </p>
      </div>
      ...
      <div class="grid gap-5 sm:grid-cols-2 xl:grid-cols-4">
        ...
        >
          ...
          <div class="absolute inset-x-5 top-5 flex items-center justify-between">
            <span class="rounded-full border border-white/10 bg-black/55 px-3 py-1 text-xs font-black uppercase tracking-[0.16em] text-white backdrop-blur">Pro gear</span>
          ...
          <div class="absolute bottom-6 left-6 right-6 translate-y-2 transition duration-300 group-hover:translate-y-0">
            <h3 class="font-display text-5xl leading-none text-white">{{ category.name }}</h3>
            <p class="mt-3 max-w-52 text-sm leading-6 text-neutral-300">
              Premium essentials selected for serious daily training.
            </p>
