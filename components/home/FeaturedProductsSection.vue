<template>
  <section class="section-premium relative overflow-hidden bg-[#080808]">
    <div class="absolute inset-0 bg-[radial-gradient(circle_at_15%_20%,rgba(255,77,0,0.13),transparent_26rem)]" />
    <div class="container-premium">
      ...
      <div class="relative grid gap-6 sm:grid-cols-2 xl:grid-cols-4">
        <article
